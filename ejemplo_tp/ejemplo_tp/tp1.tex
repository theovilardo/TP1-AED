...
\pred{esMejorApuesta}{a_1,a_2: \TLista{\TLista{\float}},ind: \ent, rs \TLista{\float}, coop : \TLista{\bool}, ps : \TLista{\TLista{\float}}, es: \TLista{\TLista{\nat}}}{%
	\existe[unalinea]{ts1,ts2:}{\TLista{\TLista{\float}}} {\yLuego trayectoriaCorrecta(ts1, ind, rs, coop, a1, ps, es) \land trayectoriaCorrecta(ts2, ind, rs, coop, a2, ps, es) \\
	\implica ts1[ind][|ts1[ind]|-1] \geq ts2[ind][|ts2[ind]|-1]}}
