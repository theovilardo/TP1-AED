...
\begin{minipage}[t]{20cm}
	...
	|s[ind]| = |es[ind]| \land \paraTodo{s[ind][j]}{\ent}{0 \leq j < |s[ind]-1| \implica s[ind][j] = calcularRecurso(s[ind][j-1], coop, as[ind][es[ind][j]], ps[ind][es[ind][j]], calcularFondoComun(s, coop, as, ps, es, j), |s|)}Update tp1.tex
}
\end{minipage}
\vspace{1cm}
