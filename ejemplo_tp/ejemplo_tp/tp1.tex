...
\pred{esMejorApuesta}{a_1,a_2: \TLista{\TLista{\float}},ind: \ent}{\existe[unalinea]{ts1,ts2:}{\TLista{\TLista{\float}}} {\yLuego trayectoriaCorrecta(ts1,a1) \land trayectoriaCorrecta(ts2,a2) \implica ts1[ind][|ts1[ind]|-1] \geq ts2[ind][|ts2[ind]|-1]}}
