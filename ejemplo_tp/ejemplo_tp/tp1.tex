...
\begin{minipage}[t]{20cm}
	...
	|s[ind]| = |es[ind]| \land s[ind][0]  =  rs[ind] \land \paraTodo{j}{\ent}{0 < j \leq |s[ind]-1| \implica s[ind][j] = calcularRecurso(s[ind][j-1], coop, as[ind][es[ind][j-1]], ps[ind][es[ind][j-1]], calcularFondoComun(s, coop, as, ps, es, j-1), |s|) }
}
\end{minipage}
\vspace{1cm}
